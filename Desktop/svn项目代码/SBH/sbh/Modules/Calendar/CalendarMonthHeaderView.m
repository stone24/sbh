...
#define CATDayLabelWidth  ([UIApplication sharedApplication].keyWindow.frame.size.width-40)/7
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 5.0f, [UIApplication sharedApplication].keyWindow.frame.size.width-20, 15.f)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:13.0f]];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    [self addSubview:self.masterLabel];
    
    CGFloat xOffset = 5.0f;
    CGFloat yOffset = 22.0f;
    ...
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:13.0f]];
    self.day1OfTheWeekLabel = dayOfTheWeekLabel;
    self.day1OfTheWeekLabel.textAlignment = NSTextAlignmentCenter;
    self.day1OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME1;
    ...
    self.day2OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    ...
    self.day3OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    ...
    self.day4OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    ...
    self.day5OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    ...
    self.day6OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME;
    ...
    self.day7OfTheWeekLabel.textColor = [UIColor blackColor];//COLOR_THEME1;
    [self addSubview:self.day7OfTheWeekLabel];
    
    [self updateWithDayNames:@[@"日", @"一", @"二", @"三", @"四", @"五", @"六"]];
    sepLineView = [[UIImageView alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame)-2, CGRectGetWidth(self.frame), 1)];
