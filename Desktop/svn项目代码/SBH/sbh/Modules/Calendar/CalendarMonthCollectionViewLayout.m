...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(CGRectGetWidth([UIApplication sharedApplication].keyWindow.bounds), 50.0f);//头部视图的框架大小
        
        self.itemSize = CGSizeMake(CGRectGetWidth([UIApplication sharedApplication].keyWindow.bounds)/7, 50.0f);//每个cell的大小
